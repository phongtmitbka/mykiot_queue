...
class UpdateEsDataEveryMinute extends Command
{
    ...
    public function handle()
    {
        ...
        \DB::table('cache_products')
            ...
            ->select('cache_products.id as id', 'cache_products.store_id as store_id', 'cache_products.refer_id as refer_id', 'cache_products.data as data', 'products.views as views', 'products.sold_count as sold_count', 'products.status as status')
